            ...
            <div className="card flex-shrink-0 w-full max-w-sm shadow-2xl bg-base-100  py-20">
                ...
                <form onSubmit={handleLogin} className="card-body">
                    ...
                    <div className="form-control mt-6">
                        <input className="btn btn-warning  bg-orange-600" type="submit" value='Login' />

                    </div>
                </form>
                <p className='text-center'>New to QucikEat <Link className='text-orange-600 font-bold' to='/signup'>Sign Up</Link></p>
            </div>
        </div>
    </div>
    );
